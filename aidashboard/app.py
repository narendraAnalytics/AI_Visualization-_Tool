...
if uploaded_file:
    ...
    # Layout
    tab1, tab2, tab3, tab4 = st.tabs(["Univariate Analysis", "Bivariate Analysis", "Multivariate Analysis", "Top 5 Market Share"])
    ...
    with tab1:
        ...
        if selected_column:
            ...
            with st.expander("View Distribution Plot", expanded=True):
